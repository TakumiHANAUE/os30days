...
void HariMain(void)
{
    ...
    putfonts8_asc(binfo->vram, binfo->scrnx, 0, 32, COL8_FFFFFF, (unsigned char *)s);
        ...
        else
        {
            ...
            else if (fifo8_status(&mouseinfo) != 0)
            {
                ...
                if (mouse_decode(&mdec, i) != 0)
                {
                    ...
                    putfonts8_asc(binfo->vram, binfo->scrnx, 32, 16, COL8_FFFFFF, (unsigned char *)s);
                    /* マウスカーソルの移動 */
                    ...
                    putfonts8_asc(binfo->vram, binfo->scrnx, 0, 0, COL8_FFFFFF, (unsigned char *)s); /* 座標書く */
